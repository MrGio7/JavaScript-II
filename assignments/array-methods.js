...
let largeShirts = runners.filter(function(i){ 
...
let ticketPriceTotal = runners.reduce(function (o, i){
    return o + i.donation;
}, 0);
...
// Problem 1
// Need to count M shirt size companies donation.
let mediumShirts = runners.filter(function(i){ 
    return i.shirt_size == 'M';
});

let mediumShirtsDonations = mediumShirts.reduce(function(o, i){
    return 0 + i.donation;
}, 0);
